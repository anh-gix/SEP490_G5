 ...
 * Sidebar navigation chung cho tất cả roles (Student, Teacher, Academic, CenterHead)
 *
 * @param {Object} props
 * @param {string} props.roleTitle - Tiêu đề role (VD: "Học viên", "Giảng viên", "Giáo vụ", "Trưởng Trung Tâm")
 * @param {string} props.roleSubtitle - Phụ đề role (VD: "Cổng thông tin", "Giảng dạy", "Quản lý")
  ...
  return (
    <div className="role-navigation bg-white d-flex flex-column"
      ...
      <style>{`
        ...
        .role-navigation::-webkit-scrollbar-thumb:hover {
          background: #9CA3AF;
        }
