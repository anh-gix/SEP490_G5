...
const CenterHeadExamSuccessModal = ({ show, examData, onViewExam, onCreateAnother, onGoToExamList }) => {
  if (!show) return null;
        ...
        <div className="modal-content border-0 shadow-lg">
          <div className="modal-body p-5 text-center">
            ...
            <h3 className="fw-bold text-neutral-900 mb-3">
              Đã hoàn thành đề thi thành công!
            </h3>
...
CenterHeadExamSuccessModal.propTypes = {
...
export default CenterHeadExamSuccessModal;
