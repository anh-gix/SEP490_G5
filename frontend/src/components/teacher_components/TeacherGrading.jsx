...
import { gradingAssignmentsMock, submissionsMock } from './teacher_mockdata';
...
const TeacherGrading = () => {
  ...
  const fetchPendingAssignments = async () => {
    ...
    // const response = await teacherAPI.getPendingAssignments();
    // setAssignments(response.data);
    
    // Using mock data
    setAssignments(gradingAssignmentsMock);
  };
