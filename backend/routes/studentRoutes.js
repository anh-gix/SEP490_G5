...
router.get(
  ...
  verifyToken,
  isStudent,
  studentController.getMyClassDetail
);
router.get(
  "/me/schedule",
  verifyToken,
...
router.get(
  ...
  verifyToken,
  isStudent,
  studentController.getLessonDetail
);
...
router.get(
  ...
  verifyToken,
  isStudent,
  studentController.getClassMaterials
);
router.get(
  "/me/classes/:classId/homework",
  verifyToken,
  isStudent,
  studentController.getClassHomework
);
router.get(
  "/me/classes/:classId/progress",
  verifyToken,
  isStudent,
  studentController.getClassProgress
);

// Homework submission
router.post(
  "/me/classes/:classId/schedules/:scheduleId/homework/:homeworkId/submit",
  verifyToken,
  isStudent,
...
router.get(
  "/me/classes/:classId/schedules/:scheduleId/homework/:homeworkId/submission",
  verifyToken,
  isStudent,
...
router.patch(
  "/:id/courses",
  verifyToken,
  studentController.updateStudentCourseEnrollments
);
...
router.patch(
  "/:id/change-class",
  verifyToken,
  studentController.changeStudentClass
);
...
router.post("/import", verifyToken, studentController.importStudents);
